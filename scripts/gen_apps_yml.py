...
# group memberships (Ansible can't loop import_playbook). Written to a
# separate host-services.yml so the deploy ordering (bootstrap → host-services
# → apps) stays explicit in site.yml.
