...
module "outline" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/outline/terraform?ref=v3.5.10"
...
module "steward" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/steward/terraform?ref=v3.5.10"
  ...
  tier_access_level            = try(var.apps.steward.tier_access_level, "delegate")
...
module "vikunja" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/vikunja/terraform?ref=v3.5.10"
...
module "bentopdf" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/bentopdf/terraform?ref=v3.5.10"
...
module "privacy_policy" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/privacy-policy/terraform?ref=v3.5.10"
...
module "broadsheet" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/broadsheet/terraform?ref=v3.5.10"
  ...
  tier_access_level       = try(var.apps.broadsheet.tier_access_level, "delegate")
...
module "nextcloud" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/nextcloud/terraform?ref=v3.5.10"
...
module "decidim" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/decidim/terraform?ref=v3.5.10"
...
module "jitsi" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/jitsi/terraform?ref=v3.5.10"
...
module "espocrm" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/espocrm/terraform?ref=v3.5.10"
  ...
  tier_access_level              = try(var.apps.espocrm.tier_access_level, "delegate")
...
module "n8n" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/apps/n8n/terraform?ref=v3.5.10"
...
locals {
  ...
  # paths, alert rules. Coalesce nulls. Core-tier services (loki/prometheus/
  # grafana/wazuh) self-aggregate internally inside module.core to avoid a
  # cross-module cycle, so they don't appear in this list.
...
# Loki / Prometheus / Grafana / Wazuh moved to platform/core/ at v3.4.0 and
# compose under a single module.core block (see core.tf). Their monitoring
# self-aggregation lives inside module.core to avoid a cross-module cycle.
...
module "backrest" {
  source   = "git::https://github.com/sheyaln/sabokit.git//platform/apps/backrest/terraform?ref=v3.5.10"
  ...
  icon_url             = try(var.apps.backrest.icon_url, "")
...
module "protonmail_bridge" {
  source = "git::https://github.com/sheyaln/sabokit.git//platform/bootstrap/protonmail-bridge/terraform?ref=v3.5.10"
