...
<div style="text-align: center; padding: 20px; border: 2px solid #333; border-radius: 8px; background-color: #1a1a1a;">
  <h2 style="color: #ffffff;">Account inactive</h2>
  <p style="font-size: 16px; margin: 20px 0; color: #ffffff;">
    Your ${organisation_name} Gateway account is currently inactive. Please reach out to a delegate to get it reactivated.
  </p>
  <p style="font-size: 13px; color: #cccccc; margin-top: 20px;">
    Login is blocked until a delegate reactivates the account.
