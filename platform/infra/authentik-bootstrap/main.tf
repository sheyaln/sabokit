...
locals {
  ...
  admin_api_token = random_password.admin_api_token[0].result
  server_key      = random_id.server_key[0].hex

  admin_secret_id  = scaleway_secret.admin[0].id
  server_secret_id = scaleway_secret.server[0].id
}
