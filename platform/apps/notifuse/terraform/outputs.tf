...
output "backup_plan" {
  description = "Backrest backup plan contribution. null when disabled or backup_enabled = false. Aggregated by consumer-template into backrest's backup_plans. Data lives in `/opt/notifuse/data` (covered by opt_dir); RDB postgres and S3 templates bucket have their own managed backups."
